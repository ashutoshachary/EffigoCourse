package com.ashutosh.multipleDataBase.config;
...
@EnableJpaRepositories(
  ...
  basePackages = { "com.ashutosh.multipleDataBase.accountdb.repository" }
)
public class AccountDataSourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean accountEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder
				...
				.packages("com.ashutosh.multipleDataBase.accountdb.entity")
				.build();
	}
