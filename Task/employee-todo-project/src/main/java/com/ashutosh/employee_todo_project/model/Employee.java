...
public class Employee {
    ...
    public Employee(String id, @NotBlank(message = "Employee name is required") String employeeName,
			@Email(message = "Please provide a valid email") @NotBlank(message = "Email is required") String email,
			@Pattern(regexp = "^\\d{10}$", message = "Phone number must be 10 digits") String phoneNumber,
			String photoUrl, Department department, String resumeUrl,
			@NotBlank(message = "Address is required") String address, boolean isMale,
